...
def control_loop(c):
    ...
    def compute(setpoint, measured, dt):
    ...
    while c.running:
        ...
        print("Sensor count =", c.sensor_count)
        print("Sensors =", c.sensor_values[:5])
        ...
        if total == 0:
            ...
            measured = weighted_sum / total
        
        print("kp =", kp, "ki =", ki, "kd =", kd)
        u = compute(setpoint, measured, dt)
